...
def evaluate_models():
    ...
    print("Precision :", precision_score(y_test, decision_prediction))
    print("Recall :", recall_score(y_test, decision_prediction))
    print("F1 Score :", f1_score(y_test, decision_prediction))
    ...
    print("Precision :", precision_score(y_test, random_prediction))
    print("Recall :", recall_score(y_test, random_prediction))
    print("F1 Score :", f1_score(y_test, random_prediction))
    ...
    return best_model, X_test, y_test, scaler
